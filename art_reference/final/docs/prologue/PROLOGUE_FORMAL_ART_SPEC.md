...
| 类型 | 尺寸 | 路径 |
|---|---:|---|
| 正式母版 | 1536 x 864 或更高 16:9 PNG | `art_reference/final/pixel_battle/backgrounds/formal/prologue/*.png` |
| 运行导出 | 1280 x 720 PNG | `assets/pixel_battle/backgrounds/formal/prologue/*.png` |
| 提示词 | Markdown | `art_reference/final/docs/prologue/PROLOGUE_FORMAL_PROMPTS.md` |
