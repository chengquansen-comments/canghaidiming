...
REPORT_PATH = Path("data/design/generated_minimal_playable_round_report.tsv")
...
def main() -> int:
    parser = argparse.ArgumentParser(description="验证 generated minimal playable round 报告")
    ...
    for row in generated_rows:
        ...
        if not enemy_intent_ok:
            print("FAIL: enemy_intent_available 和 enemy_action_candidate_available 均为 false")
            print("RESULT: FAIL")
            return 1
    ...
    print("PASS: generated node=16，selected node 已达到 round_initialized/player_input_ready")
    print("PASS: enemy/card/reward/narrative/route 与 fallback/写保护通过")
    print("RESULT: PASS")
    return 0
