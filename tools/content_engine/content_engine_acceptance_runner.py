...
def write_step_md(path: Path, run_id: str, rows: list[dict[str, str]]) -> None:
    ...
    lines.extend(
        [
            ...
            "## 说明",
            "",
            "- 本 runner 顺序执行 shadow freeze、runtime harness、full preview readonly、full package shadow compare、full package candidate path、full package whitelist test enable、runtime readiness audit、runtime bridge contract、Godot runtime bridge spine、regression 链路。",
