...
def main() -> int:
    ...
    steps = [
        ...
        ("generated_node_route_flow_probe", "godot --headless --path . --script tools/content_engine/generated_node_route_flow_probe.gd"),
        ...
        ("generated_node_battle_start_probe", "godot --headless --path . --script tools/content_engine/generated_node_battle_start_probe.gd"),
        ("generated_node_battle_start_validator", "python3 tools/content_engine/generated_node_battle_start_validator.py"),
        ("generated_playable_battle_entry_probe", "godot --headless --path . --script tools/content_engine/generated_playable_battle_entry_probe.gd"),
        ...
        ("generated_playable_loop_probe", "godot --headless --path . --script tools/content_engine/generated_playable_loop_probe.gd"),
        ("generated_playable_loop_validator", "python3 tools/content_engine/generated_playable_loop_validator.py"),
        ("generated_player_visible_entry_probe", "godot --headless --path . --script tools/content_engine/generated_player_visible_entry_probe.gd"),
        ...
        ("generated_real_node_entry_probe", "godot --headless --path . --script tools/content_engine/generated_real_node_entry_probe.gd"),
        ("generated_real_node_entry_validator", "python3 tools/content_engine/generated_real_node_entry_validator.py"),
