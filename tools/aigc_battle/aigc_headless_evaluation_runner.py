...
def simulate_encounter(
    ...
    event = {
        ...
        "telemetry_detail_level": "real",
        "evaluation_policy": "deterministic_headless",
        "sequence_template_id": str(runtime_manifest.get("sequence_template_id", slot.get("sequence_template_id", ""))),
        ...
        "stage": str(mapping.get("stage", slot.get("stage", ""))),
        "stage_index": int(mapping.get("stage_index", 0) or 0),
        "target_power_min": int(mapping.get("target_power_min", slot.get("target_power_min", 0)) or 0),
        "target_power_max": int(mapping.get("target_power_max", slot.get("target_power_max", 0)) or 0),
        "mechanic_density_target": float(mapping.get("mechanic_density_target", slot.get("mechanic_density_target", 0.0)) or 0.0),
        "battle_started": True,
