...
- `replace_dead_card` | severity=medium | encounter=- | card=weapon_followup_v0_1_blademaster_boss_focus | safe=True
- `reduce_overused_card` | severity=medium | encounter=- | card=weapon_followup_v0_1_blademaster_early_strike | safe=True
- `reduce_overused_card` | severity=medium | encounter=- | card=weapon_followup_v0_1_blademaster_late_strike | safe=True
- `reduce_overused_card` | severity=medium | encounter=- | card=weapon_followup_v0_1_spearman_early_strike | safe=True
- `reduce_overused_card` | severity=medium | encounter=- | card=weapon_followup_v0_1_blademaster_boss_finisher | safe=True
- `reduce_overused_card` | severity=medium | encounter=- | card=weapon_followup_v0_1_blademaster_boss_pressure | safe=True
- `reduce_overused_card` | severity=medium | encounter=- | card=weapon_followup_v0_1_blademaster_boss_strike | safe=True
- `reduce_overused_card` | severity=medium | encounter=- | card=weapon_followup_v0_1_blademaster_late_finisher | safe=True
- `reduce_overused_card` | severity=medium | encounter=- | card=weapon_followup_v0_1_blademaster_early_finisher | safe=True
