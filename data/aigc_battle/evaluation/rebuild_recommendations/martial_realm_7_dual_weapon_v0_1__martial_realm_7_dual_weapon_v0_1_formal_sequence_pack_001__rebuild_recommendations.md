...
- `reduce_overused_card` | severity=medium | encounter=- | card=martial_realm_7_dual_weapon_v0_1_blademaster_2_finisher | safe=True
- `reduce_overused_card` | severity=medium | encounter=- | card=martial_realm_7_dual_weapon_v0_1_spearman_3_finisher | safe=True
- `reduce_overused_card` | severity=medium | encounter=- | card=martial_realm_7_dual_weapon_v0_1_spearman_4_finisher | safe=True
- `reduce_overused_card` | severity=medium | encounter=- | card=martial_realm_7_dual_weapon_v0_1_spearman_4_guard | safe=True
- `reduce_overused_card` | severity=medium | encounter=- | card=martial_realm_7_dual_weapon_v0_1_spearman_4_strike | safe=True
- `reduce_overused_card` | severity=medium | encounter=- | card=martial_realm_7_dual_weapon_v0_1_blademaster_6_finisher | safe=True
- `reduce_overused_card` | severity=medium | encounter=- | card=martial_realm_7_dual_weapon_v0_1_blademaster_6_pressure | safe=True
- `reduce_overused_card` | severity=medium | encounter=- | card=martial_realm_7_dual_weapon_v0_1_spearman_1_finisher | safe=True
