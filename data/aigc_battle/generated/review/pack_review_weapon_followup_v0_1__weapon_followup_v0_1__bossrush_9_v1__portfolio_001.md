# Pack 审核表：weapon_followup_v0_1 / weapon_followup_v0_1__bossrush_9_v1__portfolio_001

## 包基本信息
- active: 否
- pack_storage_mode: `profile_pack_dir`
- runtime_manifest_path: `data/aigc_battle/generated/weapon_followup_v0_1/packs/weapon_followup_v0_1__bossrush_9_v1__portfolio_001/runtime_manifest.json`
...
- #7 `enc_wuke_blade_trial` | tier=boss | kind=boss | power=54.6 | reward=boss | risk=close_to_target_power_min
- #8 `enc_wuke_final_duel` | tier=boss | kind=boss | power=54.6 | reward=rare | risk=close_to_target_power_min
- #9 `enc_wuke_gu_chengyue` | tier=boss | kind=boss | power=54.6 | reward=boss | risk=close_to_target_power_min
