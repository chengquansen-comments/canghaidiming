# AIGC Battle 审核报告：weapon_followup_v0_1 / weapon_followup_balance_release_004
...
## 2. 机制摘要
- runtime_manifest_path: `data/aigc_battle/generated/weapon_followup_v0_1/packs/weapon_followup_balance_release_004/runtime_manifest.json`
...
- #5 `enc_wakou_boss` | boss/boss | power=18.6 | reward=boss | wujing=4
- #6 `enc_wuke_spear_trial` | mid/elite | power=18.6 | reward=mid | wujing=2
- #7 `enc_wuke_blade_trial` | mid/elite | power=18.6 | reward=mid | wujing=2
- #8 `enc_wuke_final_duel` | boss/boss | power=18.6 | reward=boss | wujing=4
- #9 `enc_wuke_gu_chengyue` | mid/elite | power=18.6 | reward=mid | wujing=2
- #10 `enc_wuke_shen_zhaoye` | mid/elite | power=18.6 | reward=mid | wujing=2
- #11 `enc_wuke_qi_heng` | late/elite | power=18.6 | reward=late | wujing=3
- #12 `enc_ch2_reed_ambush` | late/normal | power=18.6 | reward=late | wujing=3
- #13 `enc_ch3_escort_clash` | late/elite | power=18.6 | reward=late | wujing=3
- #14 `enc_ch4_tide_bandits` | late/normal | power=18.6 | reward=late | wujing=3
- #15 `enc_boss_ext_wakou_leader` | boss/boss | power=18.6 | reward=boss | wujing=4
...
- `weapon_followup_v0_1_deck_005` | archetype=`generic_mixed` | A=7.0 D=5.6 M=6.0 B=6.0
- `weapon_followup_v0_1_deck_006` | archetype=`spear_pressure` | A=7.0 D=5.6 M=6.0 B=6.0
- `weapon_followup_v0_1_deck_007` | archetype=`generic_mixed` | A=7.0 D=5.6 M=6.0 B=6.0
- `weapon_followup_v0_1_deck_008` | archetype=`generic_mixed` | A=7.0 D=5.6 M=6.0 B=6.0
- `weapon_followup_v0_1_deck_009` | archetype=`generic_mixed` | A=7.0 D=5.6 M=6.0 B=6.0
- `weapon_followup_v0_1_deck_010` | archetype=`spear_pressure` | A=7.0 D=5.6 M=6.0 B=6.0
- `weapon_followup_v0_1_deck_011` | archetype=`spear_pressure` | A=7.0 D=5.6 M=6.0 B=6.0
- `weapon_followup_v0_1_deck_012` | archetype=`spear_pressure` | A=7.0 D=5.6 M=6.0 B=6.0
- `weapon_followup_v0_1_deck_013` | archetype=`generic_mixed` | A=7.0 D=5.6 M=6.0 B=6.0
- `weapon_followup_v0_1_deck_014` | archetype=`generic_mixed` | A=7.0 D=5.6 M=6.0 B=6.0
- `weapon_followup_v0_1_deck_015` | archetype=`generic_mixed` | A=7.0 D=5.6 M=6.0 B=6.0
