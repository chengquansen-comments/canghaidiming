# AIGC Battle 审核报告：weapon_followup_v0_1 / weapon_followup_v0_1__formal_sequence_12_fast_v1__hardened_010
...
- #7 `enc_wuke_blade_trial` | late/elite | power=22.6 | reward=late | wujing=5
- #8 `enc_wuke_final_duel` | late/elite | power=26.8 | reward=late | wujing=6
- #9 `enc_wuke_gu_chengyue` | late/elite | power=23.8 | reward=late | wujing=6
- #10 `enc_wuke_shen_zhaoye` | boss/boss | power=24.6 | reward=boss | wujing=7
- #11 `enc_wuke_qi_heng` | boss/boss | power=22.8 | reward=boss | wujing=7
- #12 `enc_ch2_reed_ambush` | boss/boss | power=24.6 | reward=boss | wujing=7
