# Pack 审核表：weapon_followup_v0_1 / weapon_followup_v0_1__bossrush_9_v1__hardened_001
...
## 全序列节奏
- #1 `enc_beach_ambush` | tier=early | kind=normal | power=26.2 | reward=early | risk=early_high_power_card,realm_cap_close
- #2 `enc_fishing_village_embers` | tier=early | kind=elite | power=31.2 | reward=mid | risk=early_high_power_card,realm_cap_close
- #3 `enc_transport_officer` | tier=mid | kind=elite | power=36.2 | reward=mid | risk=realm_cap_close
- #4 `enc_mutiny_camp` | tier=mid | kind=elite | power=35.2 | reward=boss | risk=-
- #5 `enc_wakou_boss` | tier=late | kind=elite | power=49.8 | reward=boss | risk=-
- #6 `enc_wuke_spear_trial` | tier=late | kind=boss_lite | power=42.2 | reward=rare | risk=close_to_target_power_min
- #7 `enc_wuke_blade_trial` | tier=boss | kind=boss | power=51.4 | reward=boss | risk=close_to_target_power_min
- #8 `enc_wuke_final_duel` | tier=boss | kind=boss | power=55.6 | reward=rare | risk=-
- #9 `enc_wuke_gu_chengyue` | tier=boss | kind=boss | power=52.6 | reward=boss | risk=close_to_target_power_min
