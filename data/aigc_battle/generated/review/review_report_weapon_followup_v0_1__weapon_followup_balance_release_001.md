# AIGC Battle 审核报告：weapon_followup_v0_1 / weapon_followup_balance_release_001
...
## 2. 机制摘要
- runtime_manifest_path: `data/aigc_battle/generated/weapon_followup_v0_1/packs/weapon_followup_balance_release_001/runtime_manifest.json`
...
- #13 `enc_ch3_escort_clash` | late/elite | power=46.2 | reward=advanced | wujing=3
...
- `weapon_followup_v0_1_deck_013` | archetype=`boss_mixed_pressure` | A=35.64 D=8.4 M=3.0 B=17.8
