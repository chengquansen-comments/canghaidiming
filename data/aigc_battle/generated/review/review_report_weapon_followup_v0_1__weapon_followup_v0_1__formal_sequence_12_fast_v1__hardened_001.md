# AIGC Battle 审核报告：weapon_followup_v0_1 / weapon_followup_v0_1__formal_sequence_12_fast_v1__hardened_001
...
## 2. 机制摘要
- runtime_manifest_path: `data/aigc_battle/generated/weapon_followup_v0_1/packs/weapon_followup_v0_1__formal_sequence_12_fast_v1__hardened_001/runtime_manifest.json`
...
## 4. 全序列节奏
- #1 `enc_beach_ambush` | early/normal | power=25.2 | reward=early | wujing=1
- #2 `enc_fishing_village_embers` | early/normal | power=27.2 | reward=early | wujing=2
- #3 `enc_transport_officer` | early/elite | power=30.6 | reward=early | wujing=2
- #4 `enc_mutiny_camp` | mid/normal | power=32.0 | reward=mid | wujing=3
- #5 `enc_wakou_boss` | mid/elite | power=36.2 | reward=mid | wujing=4
- #6 `enc_wuke_spear_trial` | mid/elite | power=36.2 | reward=mid | wujing=4
- #7 `enc_wuke_blade_trial` | late/elite | power=48.6 | reward=late | wujing=5
- #8 `enc_wuke_final_duel` | late/elite | power=52.8 | reward=late | wujing=6
- #9 `enc_wuke_gu_chengyue` | late/elite | power=52.8 | reward=late | wujing=6
- #10 `enc_wuke_shen_zhaoye` | boss/boss | power=52.6 | reward=boss | wujing=7
- #11 `enc_wuke_qi_heng` | boss/boss | power=52.6 | reward=boss | wujing=7
- #12 `enc_ch2_reed_ambush` | boss/boss | power=55.6 | reward=boss | wujing=7
...
- `enc_transport_officer` -> deck=`weapon_followup_v0_1_deck_003` reward=`weapon_followup_v0_1_reward_003` risk=early_high_power_card,realm_cap_close
...
- `#10 enc_wuke_shen_zhaoye` | archetype=`boss_mixed_pressure` | action=`ready_for_review`
...
## 8. Deck 行为摘要
- `weapon_followup_v0_1_deck_012` | archetype=`spear_pressure` | A=53.84 D=0.0 M=11.8 B=16.0
- `weapon_followup_v0_1_deck_008` | archetype=`boss_mixed_pressure` | A=51.68 D=0.0 M=3.0 B=21.6
- `weapon_followup_v0_1_deck_009` | archetype=`spear_pressure` | A=51.68 D=0.0 M=3.0 B=21.6
- `weapon_followup_v0_1_deck_010` | archetype=`boss_mixed_pressure` | A=49.64 D=0.0 M=11.8 B=16.0
- `weapon_followup_v0_1_deck_011` | archetype=`spear_pressure` | A=49.64 D=0.0 M=11.8 B=16.0
...
- `weapon_followup_v0_1_deck_006` | archetype=`spear_pressure` | A=35.96 D=0.0 M=6.7 B=11.7
- `weapon_followup_v0_1_deck_004` | archetype=`spear_pressure` | A=34.56 D=0.0 M=6.7 B=7.7
- `weapon_followup_v0_1_deck_003` | archetype=`boss_mixed_pressure` | A=30.36 D=0.0 M=6.7 B=9.7
...
- fail_count: `2`
- warning_count: `24`
- [fail] 内容包未准备好导出 runtime。 | action=`blocked_by_runtime`
- [fail] runtime export gate 未通过。 | action=`blocked_by_runtime`
