# AIGC Battle 审核报告：weapon_followup_v0_1 / weapon_followup_v0_1__bossrush_9_v1__hardened_004
...
- #2 `enc_fishing_village_embers` | early/elite | power=20.6 | reward=mid | wujing=3
- #3 `enc_transport_officer` | mid/elite | power=22.2 | reward=mid | wujing=4
- #4 `enc_mutiny_camp` | mid/elite | power=21.2 | reward=boss | wujing=5
- #5 `enc_wakou_boss` | late/elite | power=32.2 | reward=boss | wujing=5
- #6 `enc_wuke_spear_trial` | late/boss_lite | power=26.2 | reward=rare | wujing=6
