# AIGC Battle 审核报告：martial_realm_7_dual_weapon_v0_1 / martial_realm_7_dual_weapon_v0_1__formal_sequence_15_v1__matrix_001
...
## 2. 机制摘要
- runtime_manifest_path: `data/aigc_battle/generated/martial_realm_7_dual_weapon_v0_1/packs/martial_realm_7_dual_weapon_v0_1__formal_sequence_15_v1__matrix_001/runtime_manifest.json`
...
- #2 `enc_fishing_village_embers` | early/normal | power=31.48 | reward=early | wujing=1
- #3 `enc_transport_officer` | early/normal | power=29.75 | reward=early | wujing=2
- #4 `enc_mutiny_camp` | early/elite | power=29.75 | reward=early | wujing=2
- #5 `enc_wakou_boss` | mid/normal | power=36.58 | reward=mid | wujing=3
- #6 `enc_wuke_spear_trial` | mid/normal | power=36.58 | reward=mid | wujing=3
- #7 `enc_wuke_blade_trial` | mid/elite | power=43.49 | reward=mid | wujing=4
- #8 `enc_wuke_final_duel` | mid/elite | power=45.82 | reward=mid | wujing=4
- #9 `enc_wuke_gu_chengyue` | late/elite | power=50.68 | reward=late | wujing=5
- #10 `enc_wuke_shen_zhaoye` | late/elite | power=46.72 | reward=late | wujing=5
- #11 `enc_wuke_qi_heng` | late/elite | power=52.97 | reward=late | wujing=6
- #12 `enc_ch2_reed_ambush` | late/boss | power=56.42 | reward=late | wujing=6
- #13 `enc_ch3_escort_clash` | boss/boss | power=67.31 | reward=boss | wujing=7
- #14 `enc_ch4_tide_bandits` | boss/boss | power=67.31 | reward=boss | wujing=7
...
- `enc_fishing_village_embers` -> deck=`martial_realm_7_dual_weapon_v0_1_deck_002` reward=`martial_realm_7_dual_weapon_v0_1_reward_002` risk=close_to_target_power_max,realm_cap_close
...
- `enc_wuke_qi_heng` -> deck=`martial_realm_7_dual_weapon_v0_1_deck_011` reward=`martial_realm_7_dual_weapon_v0_1_reward_011` risk=realm_cap_close
...
- `enc_ch3_escort_clash` -> deck=`martial_realm_7_dual_weapon_v0_1_deck_013` reward=`martial_realm_7_dual_weapon_v0_1_reward_013` risk=realm_cap_close
...
## 8. Deck 行为摘要
- `martial_realm_7_dual_weapon_v0_1_deck_013` | archetype=`spear_pressure` | A=63.83 D=46.78 M=28.38 B=51.52
- `martial_realm_7_dual_weapon_v0_1_deck_014` | archetype=`spear_pressure` | A=63.83 D=46.78 M=28.38 B=51.52
...
- `martial_realm_7_dual_weapon_v0_1_deck_009` | archetype=`boss_mixed_pressure` | A=55.65 D=42.25 M=8.93 B=32.64
- `martial_realm_7_dual_weapon_v0_1_deck_010` | archetype=`spear_pressure` | A=47.34 D=32.85 M=11.55 B=36.83
- `martial_realm_7_dual_weapon_v0_1_deck_008` | archetype=`spear_pressure` | A=46.58 D=30.71 M=11.97 B=28.52
- `martial_realm_7_dual_weapon_v0_1_deck_007` | archetype=`spear_pressure` | A=45.62 D=35.09 M=8.32 B=19.87
- `martial_realm_7_dual_weapon_v0_1_deck_005` | archetype=`spear_pressure` | A=37.62 D=21.91 M=10.04 B=18.61
- `martial_realm_7_dual_weapon_v0_1_deck_006` | archetype=`spear_pressure` | A=37.62 D=21.91 M=10.04 B=18.61
- `martial_realm_7_dual_weapon_v0_1_deck_001` | archetype=`spear_pressure` | A=26.06 D=10.83 M=5.66 B=11.66
- `martial_realm_7_dual_weapon_v0_1_deck_002` | archetype=`boss_mixed_pressure` | A=26.06 D=10.83 M=5.66 B=11.66
...
- `martial_realm_7_dual_weapon_v0_1_reward_004` | tier=`early` | items=basic_reward_card_004x1
...
- `martial_realm_7_dual_weapon_v0_1_reward_007` | tier=`mid` | items=basic_reward_card_007x1
- `martial_realm_7_dual_weapon_v0_1_reward_008` | tier=`mid` | items=basic_reward_card_008x1
- `martial_realm_7_dual_weapon_v0_1_reward_009` | tier=`late` | items=basic_reward_card_009x1
- `martial_realm_7_dual_weapon_v0_1_reward_010` | tier=`late` | items=basic_reward_card_010x1
- `martial_realm_7_dual_weapon_v0_1_reward_011` | tier=`late` | items=basic_reward_card_011x1
- `martial_realm_7_dual_weapon_v0_1_reward_012` | tier=`late` | items=basic_reward_card_012x1
- `martial_realm_7_dual_weapon_v0_1_reward_013` | tier=`boss` | items=boss_reward_tokenx1, resource_meritx3
- `martial_realm_7_dual_weapon_v0_1_reward_014` | tier=`boss` | items=boss_reward_tokenx1, resource_meritx3
