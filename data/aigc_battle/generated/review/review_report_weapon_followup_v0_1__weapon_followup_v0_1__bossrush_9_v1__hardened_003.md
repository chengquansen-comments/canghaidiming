# AIGC Battle 审核报告：weapon_followup_v0_1 / weapon_followup_v0_1__bossrush_9_v1__hardened_003
...
## 4. 全序列节奏
- #1 `enc_beach_ambush` | early/normal | power=20.0 | reward=early | wujing=2
- #2 `enc_fishing_village_embers` | early/elite | power=24.6 | reward=mid | wujing=3
- #3 `enc_transport_officer` | mid/elite | power=27.2 | reward=mid | wujing=4
- #4 `enc_mutiny_camp` | mid/elite | power=26.2 | reward=boss | wujing=5
- #5 `enc_wakou_boss` | late/elite | power=37.2 | reward=boss | wujing=5
- #6 `enc_wuke_spear_trial` | late/boss_lite | power=31.2 | reward=rare | wujing=6
- #7 `enc_wuke_blade_trial` | boss/boss | power=39.4 | reward=boss | wujing=7
- #8 `enc_wuke_final_duel` | boss/boss | power=43.6 | reward=rare | wujing=7
- #9 `enc_wuke_gu_chengyue` | boss/boss | power=40.6 | reward=boss | wujing=7
