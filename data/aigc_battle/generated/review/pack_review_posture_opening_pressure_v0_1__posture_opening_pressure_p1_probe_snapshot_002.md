# Pack 审核表：posture_opening_pressure_v0_1 / posture_opening_pressure_p1_probe_snapshot_002
...
## 全序列节奏
- #1 `enc_beach_ambush` | tier=early | kind=normal | power=22.8 | reward=basic | risk=realm_cap_close
...
- #5 `enc_wakou_boss` | tier=boss | kind=boss | power=53.8 | reward=boss | risk=realm_cap_close
...
- #8 `enc_wuke_final_duel` | tier=boss | kind=boss | power=53.8 | reward=boss | risk=realm_cap_close
...
- #11 `enc_wuke_qi_heng` | tier=late | kind=elite | power=49.2 | reward=advanced | risk=realm_cap_close
- #12 `enc_ch2_reed_ambush` | tier=late | kind=normal | power=43.2 | reward=advanced | risk=realm_cap_close
- #13 `enc_ch3_escort_clash` | tier=late | kind=elite | power=49.2 | reward=advanced | risk=realm_cap_close
- #14 `enc_ch4_tide_bandits` | tier=late | kind=normal | power=43.2 | reward=advanced | risk=realm_cap_close
- #15 `enc_boss_ext_wakou_leader` | tier=boss | kind=boss | power=53.8 | reward=boss | risk=realm_cap_close
