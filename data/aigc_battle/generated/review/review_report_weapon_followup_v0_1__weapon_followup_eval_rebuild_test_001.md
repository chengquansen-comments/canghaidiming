# AIGC Battle 审核报告：weapon_followup_v0_1 / weapon_followup_eval_rebuild_test_001
...
## 2. 机制摘要
- runtime_manifest_path: `data/aigc_battle/generated/weapon_followup_v0_1/packs/weapon_followup_eval_rebuild_test_001/runtime_manifest.json`
...
## 4. 全序列节奏
- #1 `enc_beach_ambush` | early/normal | power=24.2 | reward=basic | wujing=1
- #2 `enc_fishing_village_embers` | early/normal | power=24.2 | reward=basic | wujing=1
...
- #5 `enc_wakou_boss` | boss/boss | power=50.2 | reward=boss | wujing=4
- #6 `enc_wuke_spear_trial` | mid/elite | power=33.2 | reward=standard | wujing=2
- #7 `enc_wuke_blade_trial` | mid/elite | power=30.8 | reward=standard | wujing=2
...
- #13 `enc_ch3_escort_clash` | late/elite | power=47.8 | reward=advanced | wujing=3
...
- `weapon_followup_v0_1_deck_005` | archetype=`boss_mixed_pressure` | A=39.52 D=9.8 M=6.9 B=15.0
- `weapon_followup_v0_1_deck_013` | archetype=`boss_mixed_pressure` | A=36.28 D=8.4 M=3.0 B=21.6
...
- `weapon_followup_v0_1_deck_007` | archetype=`boss_mixed_pressure` | A=23.8 D=7.0 M=3.0 B=8.0
...
- `weapon_followup_v0_1_deck_001` | archetype=`spear_pressure` | A=13.56 D=11.2 M=6.2 B=6.2
- `weapon_followup_v0_1_deck_002` | archetype=`generic_mixed` | A=13.56 D=11.2 M=6.2 B=6.2
