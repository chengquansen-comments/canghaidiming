# AIGC Battle 审核报告：weapon_followup_v0_1 / weapon_followup_v0_1__bossrush_9_v1__hardened_002
...
## 2. 机制摘要
- runtime_manifest_path: `data/aigc_battle/generated/weapon_followup_v0_1/packs/weapon_followup_v0_1__bossrush_9_v1__hardened_002/runtime_manifest.json`
...
## 4. 全序列节奏
- #1 `enc_beach_ambush` | early/normal | power=22.2 | reward=early | wujing=2
- #2 `enc_fishing_village_embers` | early/elite | power=28.6 | reward=mid | wujing=3
- #3 `enc_transport_officer` | mid/elite | power=31.2 | reward=mid | wujing=4
- #4 `enc_mutiny_camp` | mid/elite | power=30.2 | reward=boss | wujing=5
- #5 `enc_wakou_boss` | late/elite | power=42.2 | reward=boss | wujing=5
- #6 `enc_wuke_spear_trial` | late/boss_lite | power=36.2 | reward=rare | wujing=6
- #7 `enc_wuke_blade_trial` | boss/boss | power=45.4 | reward=boss | wujing=7
- #8 `enc_wuke_final_duel` | boss/boss | power=49.6 | reward=rare | wujing=7
- #9 `enc_wuke_gu_chengyue` | boss/boss | power=46.6 | reward=boss | wujing=7

## 5. 战斗列表
- `enc_beach_ambush` -> deck=`weapon_followup_v0_1_deck_001` reward=`weapon_followup_v0_1_reward_001` risk=close_to_target_power_min,early_high_power_card,realm_cap_close
