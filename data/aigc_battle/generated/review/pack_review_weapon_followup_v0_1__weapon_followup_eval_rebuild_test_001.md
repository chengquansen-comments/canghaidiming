# Pack 审核表：weapon_followup_v0_1 / weapon_followup_eval_rebuild_test_001
...
## 全序列节奏
- #1 `enc_beach_ambush` | tier=early | kind=normal | power=24.2 | reward=basic | risk=realm_cap_close
- #2 `enc_fishing_village_embers` | tier=early | kind=normal | power=24.2 | reward=basic | risk=realm_cap_close
...
- #5 `enc_wakou_boss` | tier=boss | kind=boss | power=50.2 | reward=boss | risk=realm_cap_close
- #6 `enc_wuke_spear_trial` | tier=mid | kind=elite | power=33.2 | reward=standard | risk=realm_cap_close
- #7 `enc_wuke_blade_trial` | tier=mid | kind=elite | power=30.8 | reward=standard | risk=realm_cap_close
...
- #13 `enc_ch3_escort_clash` | tier=late | kind=elite | power=47.8 | reward=advanced | risk=realm_cap_close
