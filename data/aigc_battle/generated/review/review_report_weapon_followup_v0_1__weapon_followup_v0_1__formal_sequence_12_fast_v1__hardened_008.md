# AIGC Battle 审核报告：weapon_followup_v0_1 / weapon_followup_v0_1__formal_sequence_12_fast_v1__hardened_008
...
- #3 `enc_transport_officer` | early/elite | power=21.0 | reward=early | wujing=2
- #4 `enc_mutiny_camp` | mid/normal | power=20.0 | reward=mid | wujing=3
- #5 `enc_wakou_boss` | mid/elite | power=24.2 | reward=mid | wujing=4
- #6 `enc_wuke_spear_trial` | mid/elite | power=23.2 | reward=mid | wujing=4
- #7 `enc_wuke_blade_trial` | late/elite | power=34.6 | reward=late | wujing=5
- #8 `enc_wuke_final_duel` | late/elite | power=38.8 | reward=late | wujing=6
- #9 `enc_wuke_gu_chengyue` | late/elite | power=35.8 | reward=late | wujing=6
- #10 `enc_wuke_shen_zhaoye` | boss/boss | power=36.6 | reward=boss | wujing=7
- #11 `enc_wuke_qi_heng` | boss/boss | power=34.8 | reward=boss | wujing=7
- #12 `enc_ch2_reed_ambush` | boss/boss | power=36.6 | reward=boss | wujing=7
