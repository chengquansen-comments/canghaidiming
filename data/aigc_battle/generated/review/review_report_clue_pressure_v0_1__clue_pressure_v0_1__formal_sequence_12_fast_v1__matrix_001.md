# AIGC Battle 审核报告：clue_pressure_v0_1 / clue_pressure_v0_1__formal_sequence_12_fast_v1__matrix_001
...
## 2. 机制摘要
- runtime_manifest_path: `data/aigc_battle/generated/clue_pressure_v0_1/packs/clue_pressure_v0_1__formal_sequence_12_fast_v1__matrix_001/runtime_manifest.json`
...
- #7 `enc_wuke_blade_trial` | late/elite | power=49.2 | reward=late | wujing=5
- #8 `enc_wuke_final_duel` | late/elite | power=49.2 | reward=late | wujing=6
- #9 `enc_wuke_gu_chengyue` | late/elite | power=49.2 | reward=late | wujing=6
- #10 `enc_wuke_shen_zhaoye` | boss/boss | power=53.8 | reward=boss | wujing=7
- #11 `enc_wuke_qi_heng` | boss/boss | power=53.8 | reward=boss | wujing=7
- #12 `enc_ch2_reed_ambush` | boss/boss | power=53.8 | reward=boss | wujing=7

## 5. 战斗列表
- `enc_beach_ambush` -> deck=`clue_pressure_v0_1_deck_001` reward=`clue_pressure_v0_1_reward_001` risk=close_to_target_power_min,realm_cap_close
- `enc_fishing_village_embers` -> deck=`clue_pressure_v0_1_deck_002` reward=`clue_pressure_v0_1_reward_002` risk=close_to_target_power_min
- `enc_transport_officer` -> deck=`clue_pressure_v0_1_deck_003` reward=`clue_pressure_v0_1_reward_003` risk=close_to_target_power_max
- `enc_mutiny_camp` -> deck=`clue_pressure_v0_1_deck_004` reward=`clue_pressure_v0_1_reward_004` risk=close_to_target_power_min
- `enc_wakou_boss` -> deck=`clue_pressure_v0_1_deck_005` reward=`clue_pressure_v0_1_reward_005` risk=close_to_target_power_max
- `enc_wuke_spear_trial` -> deck=`clue_pressure_v0_1_deck_006` reward=`clue_pressure_v0_1_reward_006` risk=close_to_target_power_max
...
- `enc_wuke_gu_chengyue` -> deck=`clue_pressure_v0_1_deck_009` reward=`clue_pressure_v0_1_reward_009` risk=-
- `enc_wuke_shen_zhaoye` -> deck=`clue_pressure_v0_1_deck_010` reward=`clue_pressure_v0_1_reward_010` risk=close_to_target_power_min
- `enc_wuke_qi_heng` -> deck=`clue_pressure_v0_1_deck_011` reward=`clue_pressure_v0_1_reward_011` risk=close_to_target_power_min
- `enc_ch2_reed_ambush` -> deck=`clue_pressure_v0_1_deck_012` reward=`clue_pressure_v0_1_reward_012` risk=close_to_target_power_min
...
## 7. 卡池摘要
- card_count: `80`
- unused_card_count: `41`
- high_power_card_count: `20`

## 8. Deck 行为摘要
- `clue_pressure_v0_1_deck_010` | archetype=`boss_mixed_pressure` | A=32.52 D=19.6 M=7.9 B=16.0
- `clue_pressure_v0_1_deck_011` | archetype=`spear_pressure` | A=32.52 D=19.6 M=7.9 B=16.0
- `clue_pressure_v0_1_deck_012` | archetype=`spear_pressure` | A=32.52 D=19.6 M=7.9 B=16.0
- `clue_pressure_v0_1_deck_007` | archetype=`boss_mixed_pressure` | A=31.44 D=16.8 M=3.0 B=17.8
- `clue_pressure_v0_1_deck_008` | archetype=`boss_mixed_pressure` | A=31.44 D=16.8 M=3.0 B=17.8
- `clue_pressure_v0_1_deck_009` | archetype=`spear_pressure` | A=31.44 D=16.8 M=3.0 B=17.8
- `clue_pressure_v0_1_deck_005` | archetype=`boss_mixed_pressure` | A=24.76 D=7.0 M=6.7 B=11.7
- `clue_pressure_v0_1_deck_006` | archetype=`spear_pressure` | A=24.76 D=7.0 M=6.7 B=11.7
- `clue_pressure_v0_1_deck_004` | archetype=`spear_pressure` | A=24.76 D=7.0 M=6.7 B=7.7
...
- `clue_pressure_v0_1_reward_004` | tier=`mid` | items=basic_reward_card_004x1
...
- `clue_pressure_v0_1_reward_007` | tier=`late` | items=basic_reward_card_007x1
- `clue_pressure_v0_1_reward_008` | tier=`late` | items=basic_reward_card_008x1
- `clue_pressure_v0_1_reward_009` | tier=`late` | items=basic_reward_card_009x1
- `clue_pressure_v0_1_reward_010` | tier=`boss` | items=boss_reward_tokenx1, resource_meritx3
- `clue_pressure_v0_1_reward_011` | tier=`boss` | items=boss_reward_tokenx1, resource_meritx3
- `clue_pressure_v0_1_reward_012` | tier=`boss` | items=boss_reward_tokenx1, resource_meritx3
