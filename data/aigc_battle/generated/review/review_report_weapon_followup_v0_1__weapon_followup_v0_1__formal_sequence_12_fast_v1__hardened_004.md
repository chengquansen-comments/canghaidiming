# AIGC Battle 审核报告：weapon_followup_v0_1 / weapon_followup_v0_1__formal_sequence_12_fast_v1__hardened_004
...
## 2. 机制摘要
- runtime_manifest_path: `data/aigc_battle/generated/weapon_followup_v0_1/packs/weapon_followup_v0_1__formal_sequence_12_fast_v1__hardened_004/runtime_manifest.json`
...
- #6 `enc_wuke_spear_trial` | mid/elite | power=35.2 | reward=mid | wujing=4
...
- #9 `enc_wuke_gu_chengyue` | late/elite | power=49.8 | reward=late | wujing=6
...
- #12 `enc_ch2_reed_ambush` | boss/boss | power=52.6 | reward=boss | wujing=7
