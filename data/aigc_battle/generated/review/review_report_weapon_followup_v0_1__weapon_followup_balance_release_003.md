# AIGC Battle 审核报告：weapon_followup_v0_1 / weapon_followup_balance_release_003
...
## 2. 机制摘要
- runtime_manifest_path: `data/aigc_battle/generated/weapon_followup_v0_1/packs/weapon_followup_balance_release_003/runtime_manifest.json`
...
## 4. 全序列节奏
- #1 `enc_beach_ambush` | early/normal | power=18.6 | reward=basic | wujing=1
- #2 `enc_fishing_village_embers` | early/normal | power=18.6 | reward=basic | wujing=1
- #3 `enc_transport_officer` | early/elite | power=18.6 | reward=basic | wujing=1
- #4 `enc_mutiny_camp` | early/elite | power=18.6 | reward=basic | wujing=1
- #5 `enc_wakou_boss` | boss/boss | power=34.2 | reward=boss | wujing=4
- #6 `enc_wuke_spear_trial` | mid/elite | power=22.2 | reward=standard | wujing=2
- #7 `enc_wuke_blade_trial` | mid/elite | power=22.2 | reward=standard | wujing=2
- #8 `enc_wuke_final_duel` | boss/boss | power=34.2 | reward=boss | wujing=4
- #9 `enc_wuke_gu_chengyue` | mid/elite | power=22.2 | reward=standard | wujing=2
- #10 `enc_wuke_shen_zhaoye` | mid/elite | power=22.2 | reward=standard | wujing=2
- #11 `enc_wuke_qi_heng` | late/elite | power=30.0 | reward=advanced | wujing=3
- #12 `enc_ch2_reed_ambush` | late/normal | power=30.0 | reward=advanced | wujing=3
- #13 `enc_ch3_escort_clash` | late/elite | power=30.0 | reward=advanced | wujing=3
- #14 `enc_ch4_tide_bandits` | late/normal | power=30.0 | reward=advanced | wujing=3
- #15 `enc_boss_ext_wakou_leader` | boss/boss | power=34.2 | reward=boss | wujing=4
...
- `#5 enc_wakou_boss` | archetype=`momentum_breaker` | action=`needs_balance_adjustment`
- `#6 enc_wuke_spear_trial` | archetype=`spear_pressure` | action=`needs_balance_adjustment`
- `#7 enc_wuke_blade_trial` | archetype=`generic_mixed` | action=`needs_balance_adjustment`
- `#8 enc_wuke_final_duel` | archetype=`momentum_breaker` | action=`needs_balance_adjustment`
- `#9 enc_wuke_gu_chengyue` | archetype=`generic_mixed` | action=`needs_balance_adjustment`
...
- `#13 enc_ch3_escort_clash` | archetype=`momentum_breaker` | action=`needs_balance_adjustment`
- `#14 enc_ch4_tide_bandits` | archetype=`momentum_breaker` | action=`needs_balance_adjustment`
- `#15 enc_boss_ext_wakou_leader` | archetype=`momentum_breaker` | action=`needs_balance_adjustment`

## 7. 卡池摘要
- card_count: `40`
- unused_card_count: `12`
- high_power_card_count: `10`

## 8. Deck 行为摘要
- `weapon_followup_v0_1_deck_005` | archetype=`momentum_breaker` | A=11.2 D=9.8 M=8.0 B=16.0
- `weapon_followup_v0_1_deck_008` | archetype=`momentum_breaker` | A=11.2 D=9.8 M=8.0 B=16.0
- `weapon_followup_v0_1_deck_015` | archetype=`momentum_breaker` | A=11.2 D=9.8 M=8.0 B=16.0
- `weapon_followup_v0_1_deck_011` | archetype=`spear_pressure` | A=11.2 D=8.4 M=6.0 B=14.0
- `weapon_followup_v0_1_deck_012` | archetype=`spear_pressure` | A=11.2 D=8.4 M=6.0 B=14.0
- `weapon_followup_v0_1_deck_013` | archetype=`momentum_breaker` | A=11.2 D=8.4 M=6.0 B=14.0
- `weapon_followup_v0_1_deck_014` | archetype=`momentum_breaker` | A=11.2 D=8.4 M=6.0 B=14.0
- `weapon_followup_v0_1_deck_006` | archetype=`spear_pressure` | A=8.4 D=7.0 M=6.0 B=8.0
- `weapon_followup_v0_1_deck_007` | archetype=`generic_mixed` | A=8.4 D=7.0 M=6.0 B=8.0
- `weapon_followup_v0_1_deck_009` | archetype=`generic_mixed` | A=8.4 D=7.0 M=6.0 B=8.0
- `weapon_followup_v0_1_deck_010` | archetype=`spear_pressure` | A=8.4 D=7.0 M=6.0 B=8.0
- `weapon_followup_v0_1_deck_001` | archetype=`spear_pressure` | A=7.0 D=5.6 M=6.0 B=6.0
- `weapon_followup_v0_1_deck_002` | archetype=`generic_mixed` | A=7.0 D=5.6 M=6.0 B=6.0
- `weapon_followup_v0_1_deck_003` | archetype=`generic_mixed` | A=7.0 D=5.6 M=6.0 B=6.0
- `weapon_followup_v0_1_deck_004` | archetype=`spear_pressure` | A=7.0 D=5.6 M=6.0 B=6.0
