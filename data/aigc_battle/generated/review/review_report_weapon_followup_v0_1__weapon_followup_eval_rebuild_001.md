# AIGC Battle 审核报告：weapon_followup_v0_1 / weapon_followup_eval_rebuild_001
...
## 2. 机制摘要
- runtime_manifest_path: `data/aigc_battle/generated/weapon_followup_v0_1/packs/weapon_followup_eval_rebuild_001/runtime_manifest.json`
...
- #5 `enc_wakou_boss` | boss/boss | power=48.2 | reward=boss | wujing=4
...
- `weapon_followup_v0_1_deck_005` | archetype=`boss_mixed_pressure` | A=36.72 D=9.8 M=6.9 B=15.0
