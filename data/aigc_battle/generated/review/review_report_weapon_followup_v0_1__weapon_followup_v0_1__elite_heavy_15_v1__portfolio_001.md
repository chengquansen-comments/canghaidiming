# AIGC Battle 审核报告：weapon_followup_v0_1 / weapon_followup_v0_1__elite_heavy_15_v1__portfolio_001
...
## 2. 机制摘要
- runtime_manifest_path: `data/aigc_battle/generated/weapon_followup_v0_1/packs/weapon_followup_v0_1__elite_heavy_15_v1__portfolio_001/runtime_manifest.json`
...
- #3 `enc_transport_officer` | early/elite | power=27.6 | reward=mid | wujing=2
- #4 `enc_mutiny_camp` | mid/normal | power=30.0 | reward=mid | wujing=3
- #5 `enc_wakou_boss` | mid/elite | power=33.2 | reward=advanced | wujing=3
- #6 `enc_wuke_spear_trial` | mid/elite | power=33.2 | reward=advanced | wujing=4
- #7 `enc_wuke_blade_trial` | mid/elite | power=33.2 | reward=advanced | wujing=4
- #8 `enc_wuke_final_duel` | late/elite | power=50.8 | reward=advanced | wujing=5
- #9 `enc_wuke_gu_chengyue` | late/elite | power=50.8 | reward=advanced | wujing=5
- #10 `enc_wuke_shen_zhaoye` | late/elite | power=50.8 | reward=rare | wujing=6
- #11 `enc_wuke_qi_heng` | late/boss_lite | power=43.2 | reward=rare | wujing=6
- #12 `enc_ch2_reed_ambush` | late/boss_lite | power=43.2 | reward=rare | wujing=6
- #13 `enc_ch3_escort_clash` | boss/boss | power=54.6 | reward=boss | wujing=7
- #14 `enc_ch4_tide_bandits` | boss/boss | power=54.6 | reward=boss | wujing=7
- #15 `enc_boss_ext_wakou_leader` | boss/boss | power=54.6 | reward=rare | wujing=7
...
- `enc_transport_officer` -> deck=`weapon_followup_v0_1_deck_003` reward=`weapon_followup_v0_1_reward_003` risk=-
...
- `enc_wuke_final_duel` -> deck=`weapon_followup_v0_1_deck_008` reward=`weapon_followup_v0_1_reward_008` risk=close_to_target_power_max
- `enc_wuke_gu_chengyue` -> deck=`weapon_followup_v0_1_deck_009` reward=`weapon_followup_v0_1_reward_009` risk=close_to_target_power_max
- `enc_wuke_shen_zhaoye` -> deck=`weapon_followup_v0_1_deck_010` reward=`weapon_followup_v0_1_reward_010` risk=close_to_target_power_max
...
- `enc_ch3_escort_clash` -> deck=`weapon_followup_v0_1_deck_013` reward=`weapon_followup_v0_1_reward_013` risk=close_to_target_power_min
- `enc_ch4_tide_bandits` -> deck=`weapon_followup_v0_1_deck_014` reward=`weapon_followup_v0_1_reward_014` risk=close_to_target_power_min
- `enc_boss_ext_wakou_leader` -> deck=`weapon_followup_v0_1_deck_015` reward=`weapon_followup_v0_1_reward_015` risk=close_to_target_power_min
...
- `#3 enc_transport_officer` | archetype=`boss_mixed_pressure` | action=`ready_for_review`
...
## 8. Deck 行为摘要
- `weapon_followup_v0_1_deck_013` | archetype=`boss_mixed_pressure` | A=42.64 D=9.8 M=11.8 B=16.0
- `weapon_followup_v0_1_deck_014` | archetype=`boss_mixed_pressure` | A=42.64 D=9.8 M=11.8 B=16.0
...
- `weapon_followup_v0_1_deck_010` | archetype=`boss_mixed_pressure` | A=40.48 D=8.4 M=3.0 B=21.6
- `weapon_followup_v0_1_deck_011` | archetype=`spear_pressure` | A=31.44 D=8.4 M=3.0 B=17.8
...
- `weapon_followup_v0_1_reward_010` | tier=`rare` | items=basic_reward_card_010x1
- `weapon_followup_v0_1_reward_011` | tier=`rare` | items=basic_reward_card_011x1
- `weapon_followup_v0_1_reward_012` | tier=`rare` | items=basic_reward_card_012x1
- `weapon_followup_v0_1_reward_015` | tier=`rare` | items=basic_reward_card_015x1
...
- `weapon_followup_v0_1_reward_006` | tier=`advanced` | items=advanced_reward_card_006x1, resource_meritx2
- `weapon_followup_v0_1_reward_007` | tier=`advanced` | items=advanced_reward_card_007x1, resource_meritx2
- `weapon_followup_v0_1_reward_008` | tier=`advanced` | items=advanced_reward_card_008x1, resource_meritx2
- `weapon_followup_v0_1_reward_009` | tier=`advanced` | items=advanced_reward_card_009x1, resource_meritx2
- `weapon_followup_v0_1_reward_013` | tier=`boss` | items=boss_reward_tokenx1, resource_meritx3
- `weapon_followup_v0_1_reward_014` | tier=`boss` | items=boss_reward_tokenx1, resource_meritx3
