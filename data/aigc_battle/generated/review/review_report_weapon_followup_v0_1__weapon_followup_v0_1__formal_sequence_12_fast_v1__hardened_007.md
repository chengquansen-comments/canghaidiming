# AIGC Battle 审核报告：weapon_followup_v0_1 / weapon_followup_v0_1__formal_sequence_12_fast_v1__hardened_007
...
## 4. 全序列节奏
- #1 `enc_beach_ambush` | early/normal | power=19.2 | reward=early | wujing=1
- #2 `enc_fishing_village_embers` | early/normal | power=21.2 | reward=early | wujing=2
- #3 `enc_transport_officer` | early/elite | power=25.0 | reward=early | wujing=2
- #4 `enc_mutiny_camp` | mid/normal | power=25.0 | reward=mid | wujing=3
- #5 `enc_wakou_boss` | mid/elite | power=29.2 | reward=mid | wujing=4
- #6 `enc_wuke_spear_trial` | mid/elite | power=28.2 | reward=mid | wujing=4
- #7 `enc_wuke_blade_trial` | late/elite | power=40.6 | reward=late | wujing=5
- #8 `enc_wuke_final_duel` | late/elite | power=44.8 | reward=late | wujing=6
- #9 `enc_wuke_gu_chengyue` | late/elite | power=41.8 | reward=late | wujing=6
- #10 `enc_wuke_shen_zhaoye` | boss/boss | power=43.6 | reward=boss | wujing=7
- #11 `enc_wuke_qi_heng` | boss/boss | power=41.8 | reward=boss | wujing=7
- #12 `enc_ch2_reed_ambush` | boss/boss | power=43.6 | reward=boss | wujing=7
