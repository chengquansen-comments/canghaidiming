...
# Stepwise presentation FX layer.
#
# Owns SVG FX paths, FX timing/size constants, and action FX wrappers.
# Movement/turn timing constants live here because higher stepwise layers reuse them.
