...
func _ready_v032_card(
	...
	return CardData.new(p_id, p_name, p_desc, p_min_distance, p_max_distance, p_cost, p_role, p_gain_momentum, p_break_momentum, p_damage, p_guard, p_tags, p_weapon_style, p_requires_facing, p_self_move_after, p_target_push_after, p_target_pull_after, p_move_condition)
